...
{
    public class CombinationEpicClover40 : Combination
    {
        /// <summary>
        /// Transformiše matricu za igru 'EpicClover40' u kombinaciju
        /// </summary>
        ...
        public void MatrixToCombinationEpicClover40(MatrixEpicClover40 matrix, int numberOfLines, int bet)
        {
            Matrix = new byte[5, 6];
            var index = 0;
            ...
            if (no9 >= 3)
            {
                li9 = new LineInfo
                {
                    ...
                    Id = EXTRA_LINE,
                    Win = MatrixEpicClover40.WinForScatter1EpicFire40[no9 - 1] * bet * numberOfLines,
                    WinningElement = 9
                };
            }
            if (matrix.GetNumberOfElement(10) == 3)
            {
                li10 = new LineInfo
                {
                    ...
                    Id = EXTRA_LINE,
                    Win = MatrixEpicClover40.WIN_FOR_SCATTER2_EPIC_FIRE40 * bet * numberOfLines,
                    WinningElement = 10
                };
            }
            matrix.SetExpanding();

            CreateLinesInformationsTurbo(matrix, numberOfLines, bet, 0, MatrixEpicClover40.WinForWildEpicFire40, GlobalData.GameLineTurbo);
