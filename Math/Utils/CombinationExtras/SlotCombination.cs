...
using Papi.GameServer.Utils.Exceptions;
...
namespace CombinationExtras
{
    public static partial class SlotCombination
    {
        ...
        /// <summary>
        /// Proverava validnost parametara, da li je u zadatom intevalu.
        /// </summary>
        /// <param name="game"></param>
        /// <param name="gamesPlayed"></param>
        /// <param name="minGamesPlayed"></param>
        /// <param name="maxGamesPlayed"></param>
        private static void ValidateGamesPlayed(Games game, int gamesPlayed, int minGamesPlayed, int maxGamesPlayed)
        {
            if (gamesPlayed < minGamesPlayed || gamesPlayed >= maxGamesPlayed)
            {
                throw new Exception("Illegal number of gamesPlayed for game " + game + "; The number must be between " + minGamesPlayed + " and " + maxGamesPlayed + " for each cycle");
            }
        }
        ...
        /// <param name="gratisGame"> </param>
        /// <returns></returns>
        private static ICombination GetCombinationKingOfTheSea(int[,] matrixArray, int numberOfLines, int bet, bool gratisGame)
        {
        ...
        /// <param name="gratisGame"> </param>
        /// <returns></returns>
        private static ICombination GetCombinationMagicJoker(int[,] matrixArray, int numberOfLines, int bet, bool gratisGame)
        {
        ...
        /// <returns></returns>
        private static ICombination GetCombinationRingsMagic(int[,] matrixArray, int numberOfLines, int bet, bool gratisGame, byte gratisSymbol)
        {
        ...
        /// <returns></returns>
        private static ICombination GetCombinationTriple7Hot(int[,] matrixArray, int numberOfLines, int bet, bool gratisGame, byte coins)
        {
        ...
        /// <param name="gratisSymbol"> </param>
        /// <returns></returns>
        private static ICombination GetCombinationSpellbook(int[,] matrixArray, int numberOfLines, int bet, bool gratisGame, byte gratisSymbol)
        {
        ...
        /// <returns></returns>
        private static ICombination GetCombinationWildWest(int[,] matrixArray, int bet, bool gratisGame, byte additionalInformation)
        {
        ...
        /// <returns></returns>
        private static ICombination GetCombinationPyramid(int[,] matrixArray, int numberOfLines, int bet, bool gratisGame, byte pyramid)
        {
        ...
        /// <returns></returns>
        private static ICombination GetCombinationBurningIce(int[,] matrixArray, int bet, bool gratisGame, byte addInfo, ref byte[] addArray)
        {
        ...
        /// <param name="gratisGame"></param>
        /// <returns></returns>
        private static ICombination GetCombinationWildClover40(int[,] matrixArray, int bet, int numberOfLines, bool gratisGame)
        {
        ...
        /// <returns></returns>
        private static ICombination GetCombinationPirates(int[,] matrixArray, int numberOfLines, int bet, bool gratisGame, byte pirate)
        {
        ...
        /// <param name="gratisSymbol"> </param>
        /// <returns></returns>
        private static ICombination GetCombinationBookOfBruno(int[,] matrixArray, int numberOfLines, int bet, bool gratisGame, byte gratisSymbol)
        {
        ...
        /// <returns></returns>
        private static ICombination GetCombinationCrystalsOfMagic(int[,] matrixArray, int numberOfLines, int bet, bool gratisGame, byte addInfo, ref byte[] addArray, int selectedField)
        {
        ...
        /// <param name="additionalInformation"></param>
        /// <returns></returns>
        private static ICombination GetCombinationMonsters(int[,] matrixArray, int bet, bool gratisGame, byte additionalInformation)
        {
        ...
        /// <returns></returns>
        private static ICombination GetCombinationVikingGold(int bet, int gratisLeft, ref byte[] addArray, params List<byte>[] reels)
        {
            if (addArray == null)
            {
        ...
        /// <param name="reels"></param>
        /// <returns></returns>
        private static ICombination GetCombinationTemplarsQuest(bool gratisGame, int bet, byte addInfo, ref byte[] addArray, int selectField, params List<byte>[] reels)
        {
            if (addArray == null)
            {
        ...
        /// <returns></returns>
        private static ICombination GetCombinationGoldenClover(int[,] matrixArray, int numberOfLines, int bet, bool gratisGame, ref byte[] addArray, object gameData)
        {
            if (addArray == null)
            {
            ...
            var combination = new CombinationGame();
            combination.MatrixToCombination(matrix, numberOfLines, bet, gratisGame, ref addArray, config);
            return combination;
        }
        ...
        /// <param name="gameData"></param>
        /// <returns></returns>
        private static ICombination GetCombinationBookOfMayanGold(int[,] matrixArray, int numberOfLines, int bet, bool gratisGame, byte gratisSymbol, ref byte[] addArray, object gameData)
        {
            if (gameData == null)
            {
                throw new Exception("Slot Combination Reader Exception: Golden Clover gameData object is NULL!");
            ...
            var config = ((JObject)gameData).ToObject<MatrixBookOfMayanGold.BookOfMayanGoldConfig>();

            var matrix = new MatrixBookOfMayanGold();
            matrix.FromMatrixArray(matrixArray);
            var combination = new Combination();
            combination.MatrixToCombination(matrix, numberOfLines, bet, gratisGame, gratisSymbol, ref addArray, config);
            return combination;
        }
        ...
        /// <param name="addArray"></param>
        /// <returns></returns>
        private static ICombination GetCombination3WildFruits(int[,] matrixArray, int bet, bool gratisGame, byte addInfo, ref byte[] addArray)
        {
            if (addArray == null)
            {
                addArray = new byte[9];
        ...
        /// <param name="addArray"></param>
        /// <returns></returns>
        private static ICombination GetCombinationCloverCash(int[,] matrixArray, int numberOfLines, int bet, bool gratisGame, ref byte[] addArray)
        {
            if (addArray == null)
            {
        ...
        /// <summary>
        /// Daje kombinaciju za igru Wild27.
        /// </summary>
        /// <param name="matrixArray"></param>
        /// <param name="numberOfLines"></param>
        /// <returns></returns>
        ...
        private static ICombination GetCombinationWildSunburst(int[,] matrixArray, int bet, int numberOfLines, bool gratisGame)
        {
            ...
            combination.MatrixToCombinationWildSunburst(matrix, numberOfLines, bet, gratisGame);
            return combination;
        }
        ...
        /*/// <summary>
        /// Učitava matricu n×3 iz fajla.
        /// </summary>
        /// <param name="game"></param>
        /// <param name="gratisGame"></param>
        /// <param name="addInfo"></param>
        /// <returns></returns>
        private static int[,] ReadMatrixArrayFromSlotFile(Games game, bool gratisGame, byte addInfo)
        {
            try
            {
                ...
                for (var i = 0; i < n; i++)
                {
                    var reel = byteArray.Skip(skip).Take(listSize[i]).ToArray();
                    skip += listSize[i];
                    var random = SoftwareRng.Next(listSize[i]);
                    for (var j = 0; j < 6; j++)
                    {
                        matrixArray[i, j] = reel[(random + j) % listSize[i]];
                    }
                }
        ...
        /// <returns></returns>
        public static ICombination GetCombination(Games game, int bet, int numberOfLines, int gratisGamesLeft, ref byte[] additionalArray, long betModifier, byte additionalInformation = 0, int selectedField = 0, object gameDataObj = null)
        {
            if ((int)game > 1000 && (int)game <= 2000)
            {
                return GetCombinationTeam1(game, bet, numberOfLines, gratisGamesLeft, ref additionalArray, additionalInformation, selectedField, gameDataObj);
            }
            else if ((int)game > 2000 && (int)game <= 3000)
            {
                return GetCombinationTeam2(game, bet, numberOfLines, gratisGamesLeft, ref additionalArray, additionalInformation, selectedField, gameDataObj);
            }
            else if ((int)game > 3000 && (int)game <= 4000)
            {
                return GetCombinationTeam3(game, bet, numberOfLines, gratisGamesLeft, ref additionalArray, additionalInformation, selectedField, gameDataObj);
            }
            else if ((int)game > 4000 && (int)game <= 5000)
            {
                return GetCombinationTeam4(game, bet, numberOfLines, gratisGamesLeft, ref additionalArray, additionalInformation, selectedField, gameDataObj);
            }
            switch (game)
            {
                ...
                case Games.SimplyRunner:
                    return CombinationSimplyRunner.GetCombination(numberOfLines, bet, false); //TODO: videti kako da radi igra
                case Games.FruityFace:
                    return CombinationFruityFace.GetCombination(numberOfLines, bet);
                case Games.ExtraFlames10:
                case Games.ShiningPresents:
                    return CombinationExtraFlames10.GetCombination(numberOfLines, bet);
                case Games.HeatClassic5:
                    return CombinationHeatClassic5.GetCombination(numberOfLines, bet);
                case Games.AfricanTreasure:
                    return CombinationAfricanTreasure.GetCombinationAfricanTreasure(numberOfLines, bet);
                ...
                case Games.Redstone20FruitFrenzy:
                    ...
                    return Combination20FireCash.GetCombination20FruitFrenzy(bet);
                case Games.JokerTripleDouble:
                case Games.ChilliRespin:
                    return CombinationJokerTripleDouble.GetCombinationJokerTripleDouble(bet, gratisGamesLeft > 0, additionalInformation, ref additionalArray);
                case Games.HeatDouble:
                    return CombinationHeatDouble.GetCombinationHeatDouble(bet);
                case Games.Wild81:
                case Games.Redstone81VegasCrown:
                case Games.Redstone81DoubleMagic:
                    ValidateLines(game, numberOfLines, 5);
                    return CombinationWild81.GetCombinationWild81(bet);
            }
            ...
            switch (game)
            {
                ...
                case Games.TemplarsQuest:
                    ...
                    return GetCombinationTemplarsQuest(gratisGamesLeft > 0, bet, additionalInformation, ref additionalArray, selectedField, reels);
            }

            var matrixArray = ReelsReader.ReadMatrixArrayFromReels(reels);
            //var matrixArray = ReadMatrixArrayFromSlotFile(game, gratisGamesLeft > 0, additionalInformation);
            switch (game)
            {
                case Games.Postman:
                ...
                case Games.BookOfMayanGold:
                    return GetCombinationBookOfMayanGold(matrixArray, numberOfLines, bet, gratisGamesLeft > 0, additionalInformation, ref additionalArray, gameDataObj);
                ...
                case Games.HeatingFruits:
                    ...
                    if (additionalInformation != 0)
                    {
                        if (gameDataObj == null)
                        {
                            throw new Exception("Slot Combination Reader Exception: " + game + " gameData object is NULL!");
                        }
                        var config = JsonConvert.DeserializeObject<HeatingFruitsConfig>(gameDataObj.ToString());
                        //((JObject)gameDataObj).ToObject<HeatingFruitsConfig>();
                        //var config = (HeatingFruitsConfig)gameDataObj;
                        var previousBet = config.LastBet;
                        if (previousBet < bet)
                        {
                            throw new IlegalBetException("Slot Combination Reader Exception: " + game + " must have an equal or smaller bet than the previous bet! The last bet was " + previousBet + ", but now the bet is " + bet + ".");
                        }
                    }
