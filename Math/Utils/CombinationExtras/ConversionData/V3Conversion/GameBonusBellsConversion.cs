...
{
    public class GameBonusBellsConversion
    {
        public static SlotDataResV3 ToSlotDataResV3(ICombination combination)
        {
            ...
            for (var i = 0; i < 5; i++)
            {
                ...
                tmpUpperRow[i] = matrix[i, 0] == 0 || matrix[i, 0] == 9 ? (int)SoftwareRng.Next(1, 9) : matrix[i, 0];
                tmpBottomRow[i] = matrix[i, 2] == 0 || matrix[i, 2] == 9 ? (int)SoftwareRng.Next(1, 9) : matrix[i, 2];
            }
        ...
        {
            var matrixArray = gratisGamesLeft > 0 ? new[,] { { 0, 0, 0 }, { 8, 8, 8 }, { 7, 7, 7 }, { 5, 5, 5 }, { 0, 0, 0 } } : new[,] { { 4, 4, 4 }, { 8, 8, 8 }, { 7, 7, 7 }, { 5, 5, 5 }, { 6, 6, 6 } };
