...
{
    public class Game20FireCashConversion
    {
        ...
        {
            var matrixArray = new[,] { { 3, 4, 4, 4, 5 }, { 2, 3, 3, 3, 4 }, { 6, 7, 7, 7, 3 }, { 4, 5, 5, 5, 6 }, { 5, 6, 6, 6, 7 } };
        ...
        public static Combination GetNonWinningCombinationFrenzy(int bet)
        {
            var matrixArray = new[,] { { 3, 4, 4, 4, 5 }, { 2, 3, 3, 3, 4 }, { 6, 7, 7, 7, 3 }, { 4, 5, 5, 5, 6 }, { 5, 6, 6, 6, 7 } };
            var matrix = new Matrix20FireCash();
            matrix.FromMatrixArray20FireCash(matrixArray);
