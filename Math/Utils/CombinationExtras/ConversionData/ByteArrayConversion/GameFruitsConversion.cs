...
namespace CombinationExtras.ConversionData.ByteArrayConversion
{
    class GameFruitsConversion
    {
            ...
            ICombination combination)
        {
            ...
            Array.Copy(combination.PositionFor2, 0, data, k, 1);
            k++;

            emptyArray = Enumerable.Repeat((byte)255, 23).ToArray();
            Array.Copy(emptyArray, 0, data, k, 23);
            k += 23;
