...
namespace GameTurboStars20
{
    public class CombinationTurboStars20 : Combination
    {
        public void MatrixToCombination(MatrixTurboStars20 matrix, int numberOfLines, int bet, byte stars,
            bool addFenix = true)
        {
            if (addFenix)
            {
        ...
        protected void CreateLinesInformationsStars(MatrixTurboStars20 matrix, int numberOfLines, int bet)
        {
            TotalWin = 0;
