...
{
    [TestClass]
    public sealed class Unicorn20MegaFlamesTest : BaseTestClass
    {
      

        [TestMethod]
        [DataRow(Games.Unicorn20MegaFlames, 20)]
        [DataRow(Games.Unicorn20DiceFlames, 20)]
        ...
        [TestMethod]
        [DataRow(Games.Unicorn20MegaFlames, 20, 20, 96.0, 20000, 2000000)]
        [DataRow(Games.Unicorn20DiceFlames, 20, 20, 96.0, 20000, 2000000)]
