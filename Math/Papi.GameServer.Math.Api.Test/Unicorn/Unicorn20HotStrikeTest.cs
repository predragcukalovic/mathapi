...
{
    [TestClass]
    public sealed class Unicorn20HotStrikeTest : BaseTestClass
    {
      

        [TestMethod]
        [DataRow(Games.Unicorn20HotStrike, 20)]
        [DataRow(Games.UnicornDoubleWildDice, 20)]
        [DataRow(Games.Unicorn20HotStrikeDice, 20)]
        ...
        [TestMethod]
        [DataRow(Games.Unicorn20HotStrike, 20, 20, 96.0, 20000, 2000000)]
        [DataRow(Games.UnicornDoubleWildDice, 20, 20, 96.0, 20000, 2000000)]
        [DataRow(Games.Unicorn20HotStrikeDice, 20, 20, 96.0, 20000, 2000000)]
