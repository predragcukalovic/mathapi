...
{
    [TestClass]
    public sealed class UnicornHavanaDiceTest : BaseTestClass
    {
      

        [TestMethod]
        [DataRow(Games.UnicornHavanaDice, 10)]
        [DataRow(Games.UnicornCasinoFruits, 10)]
        [DataRow(Games.UnicornReelyWildReels, 10)]
        ...
        [TestMethod]
        [DataRow(Games.UnicornHavanaDice, 10, 10, 96.0, 20000, 2000000)]
        [DataRow(Games.UnicornCasinoFruits, 10, 10, 96.0, 20000, 2000000)]
        [DataRow(Games.UnicornReelyWildReels, 10, 10, 96.0, 20000, 2000000)]
