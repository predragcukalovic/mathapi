...
{
    [TestClass]
    public sealed class UnicornMiniMegaCashTest : BaseTestClass
    {
      

        [TestMethod]
        [DataRow(Games.UnicornMiniMegaCash, 10)]
        [DataRow(Games.UnicornDiceMegaCash, 10)]
        ...
        [TestMethod]
        [DataRow(Games.UnicornMiniMegaCash, 10, 10, 96.0, 20000, 2000000)]
        [DataRow(Games.UnicornDiceMegaCash, 10, 10, 96.0, 20000, 2000000)]
