using Papi.GameServer.Math.Api.Test;
...
{
    [TestClass]
    public sealed class UnicornFruitIslandChristmasTest : BaseTestClass
    {
      

        [TestMethod]
        [DataRow(Games.UnicornFruitIslandChristmas, 5)]
        ...
        [TestMethod]
        [DataRow(Games.UnicornFruitIslandChristmas, 5, 5, 96.0, 20000, 2000000)]
