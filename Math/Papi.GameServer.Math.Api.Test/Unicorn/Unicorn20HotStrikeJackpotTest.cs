...
{
    [TestClass]
    public sealed class Unicorn20HotStrikeJackpotTest : BaseTestClass
    {
      

        [TestMethod]
        [DataRow(Games.Unicorn20HotStrikeJackpot, 20)]
        [DataRow(Games.Unicorn20HotStrikeDiceJackpot, 20)]
        ...
        [TestMethod]
        [DataRow(Games.Unicorn20HotStrikeJackpot, 20, 20, 96.0, 20000, 2000000)]
        [DataRow(Games.Unicorn20HotStrikeDiceJackpot, 20, 20, 96.0, 20000, 2000000)]
