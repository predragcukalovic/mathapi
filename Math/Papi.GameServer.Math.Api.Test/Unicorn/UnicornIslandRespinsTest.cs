...
{
    [TestClass]
    public sealed class UnicornIslandRespinsTest : BaseTestClass
    {
      

        [TestMethod]
        [DataRow(Games.UnicornIslandRespins, 10)]
        ...
        [TestMethod]
        [Ignore]
        [DataRow(Games.UnicornIslandRespins, 10, 10, 96.0, 20000, 2000000)]
