...
{
    [TestClass]
    public sealed class UnicornDaVincisFruitsTest : BaseTestClass
    {      
        [TestMethod]
        [DataRow(Games.UnicornDaVincisFruits, 5)]
        ...
        [TestMethod]
        [DataRow(Games.UnicornDaVincisFruits, 5, 5, 96.0, 20000, 2000000)]
