...
{
    [TestClass]
    public sealed class UnicornWinterFruitsTest : BaseTestClass
    {
      

        [TestMethod]
        [DataRow(Games.UnicornWinterFruits, 40)]
        [DataRow(Games.Unicorn40HotStrike, 40)]
        [DataRow(Games.Unicorn40HotStrikeDice, 40)]
        ...
        [TestMethod]
        [DataRow(Games.UnicornWinterFruits, 40, 40, 96.0, 50000,2000000)]
        [DataRow(Games.Unicorn40HotStrike, 40, 40, 96.0, 20000, 2000000)]
        [DataRow(Games.Unicorn40HotStrikeDice, 40, 40, 96.0, 20000, 2000000)]
