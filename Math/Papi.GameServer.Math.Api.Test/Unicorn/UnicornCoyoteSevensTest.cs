...
{
    [TestClass]
    public sealed class UnicornCoyoteSevensTest : BaseTestClass
    {
      

        [TestMethod]
        [DataRow(Games.UnicornCoyoteSevens, 5)]
        [DataRow(Games.UnicornCoyoteDice, 5)]
        [DataRow(Games.UnicornSavanaFruits, 5)]
        ...
        [TestMethod]
        [DataRow(Games.UnicornCoyoteSevens, 5, 5, 96.0, 20000, 2000000)]
        [DataRow(Games.UnicornCoyoteDice, 5, 5, 96.0, 20000, 2000000)]
        [DataRow(Games.UnicornSavanaFruits, 5, 5, 96.0, 20000, 2000000)]
