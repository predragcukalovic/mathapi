...
{
    [TestClass]
    public sealed class UnicornWildParadiseTest : BaseTestClass
    {


        [TestMethod]
        [DataRow(Games.UnicornWildParadise, 10)]
        [DataRow(Games.UnicornTheCrownFruit, 10)]
        [DataRow(Games.UnicornFruitMagic, 10)]
        [DataRow(Games.UnicornDynamiteRun, 10)]
        [DataRow(Games.UnicornDynamiteRunPlatinum, 10)]
        ...
        [TestMethod]
        [DataRow(Games.UnicornWildParadise, 10, 10, 96.0, 20000, 2000000)]
        [DataRow(Games.UnicornTheCrownFruit, 10, 10, 96.0, 20000, 2000000)]
        [DataRow(Games.UnicornFruitMagic, 10, 10, 96.0, 20000, 2000000)]
        [DataRow(Games.UnicornDynamiteRun, 10, 10, 96.0, 20000, 2000000)]
        [DataRow(Games.UnicornDynamiteRunPlatinum, 10, 10, 96.0, 20000, 2000000)]
