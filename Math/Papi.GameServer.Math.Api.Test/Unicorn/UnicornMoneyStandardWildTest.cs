...
{
    [TestClass]
    public sealed class UnicornMoneyStandardWildTest : BaseTestClass
    {
      

        [TestMethod]
        [DataRow(Games.UnicornMoneyStandardWild, 20)]
        ...
        [TestMethod]
        [DataRow(Games.UnicornMoneyStandardWild, 20, 20, 96.0, 50000, 20000000)]
