...
{
    [TestClass]
    public sealed class Unicorn40MegaFlamesTest : BaseTestClass
    {
      

        [TestMethod]
        [DataRow(Games.Unicorn40MegaFlames, 40)]
        [DataRow(Games.Unicorn40DiceFlames, 40)]
        ...
        [TestMethod]
        [DataRow(Games.Unicorn40MegaFlames, 40, 40, 96.0, 20000, 2000000)]
        [DataRow(Games.Unicorn40DiceFlames, 40, 40, 96.0, 20000, 2000000)]
