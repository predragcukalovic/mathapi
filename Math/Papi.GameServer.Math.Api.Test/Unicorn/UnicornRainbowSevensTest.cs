...
{
    [TestClass]
    public sealed class UnicornRainbowSevensTest : BaseTestClass
    {
        

        [TestMethod]
        [DataRow(Games.UnicornRainbowSevens, 5)]
        ...
        [TestMethod]
        [DataRow(Games.UnicornRainbowSevens, 5, 5, 96.0, 20000, 2000000)]
