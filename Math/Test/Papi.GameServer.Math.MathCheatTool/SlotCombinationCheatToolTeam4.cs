...
namespace Papi.GameServer.Math.MathCheatTool
{
    public static partial class SlotCombinationCheatTool
    {
        ...
        public static ICombination GetCombinationTeam4(ref CheatToolData cheatToolObject, Games game, int bet, int numberOfLines, int gratisGamesLeft,
        ref byte[] additionalArray, byte additionalInformation = 0, int selectedField = 0, object gameDataObj = null)
        {
            List<byte>[] reels = ReadReelsFromSlotFile(game, gratisGamesLeft > 0, additionalInformation);
            ...
            switch (game)
            {
                ...
                case Games.TotoFruityWin40:
                    ...
                    return GetCombinationTurboHot40(matrixArray, bet, 40, game == Games.TurboFire);
